...
CREATE TABLE `house` (
  ...
  `last_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最近数据更新时间',
...
CREATE TABLE `house_subscribe` (
  ...
  `last_update_time` timestamp NOT NULL COMMENT '记录更新时间',
  `order_time` timestamp DEFAULT NULL COMMENT '预约时间',
...
CREATE TABLE `user` (
  ...
  `last_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '上次更新记录时间',
